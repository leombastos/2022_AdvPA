...
- Explore one type of interpolation analysis (inverse distance weighted)  
...
yield17_c <- read_sf("../data/KB2_Yield_2017_clean.geojson")
...
- Show google maps street vs. satellite view  
...
```{r exporting}
write_sf(idw_pred_v,
         "../data/KB2_Yield_2017_clean_ip.geojson",
         delete_dsn = T)
```
